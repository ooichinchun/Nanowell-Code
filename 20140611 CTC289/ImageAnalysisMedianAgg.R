...
setwd("C:/Lab/Patient Samples Nanowell/New Code for Median Hypothesis Testing/20140611 CTC289")
...
PE_B.SD.corr = (PE_Agg$PE_SN+PE_Agg$PE_SD)/2
...
FITC_B.SD.corr = (FITC_Agg$FITC_SN+FITC_Agg$FITC_SD)/2
