...
setwd("C:/Lab/Patient Samples Nanowell/New Code for Median Hypothesis Testing/20150409 Diehn 9")
...
CD45.corr = (CD45$O_Mean-CD45$Sq_Mean)/CD45$Sq_Mean

Med.corr = median(CD45.corr)
SD.corr = Sn(CD45.corr, constant = 1.1926)
...
PE_B.Subset = subset(PE_B.corr,PE_B.corr>PE_B.Med.corr)
PE_B.Symmetry = c(PE_B.Subset,(PE_B.Subset * (-1)))

PE_B.SD.corr = Sn(PE_B.Symmetry, constant = 1.1926)
...
FITC_B.Subset = subset(FITC_B.corr,FITC_B.corr>FITC_B.Med.corr)
FITC_B.Symmetry = c(FITC_B.Subset,(FITC_B.Subset * (-1)))

FITC_B.SD.corr = Sn(FITC_B.Symmetry, constant = 1.1926)
